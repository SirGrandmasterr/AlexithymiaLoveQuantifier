...
export const JOURNAL_COPY = {
    ...
    settings: {
        ...
        voice: {
            ...
            deleteAll: 'Delete downloaded models',
            deleteAllConfirm: 'Delete all downloaded model files from this device to free storage?',
            freedStorage: 'All downloaded models removed.',
